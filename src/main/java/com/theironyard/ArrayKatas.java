...
public class ArrayKatas {
    ...
    public static String concatenateStrings(String[] strings){
        String answer = "";
        for (int x = 0; x < strings.length ; x = x + 1){
            answer = answer + strings[x];
        }
        return answer;
    }
    ...
    public static Object[] reverseArray(Object[] objects){
        Object[] answer = new Object[objects.length];
        for (int x = 0; x < objects.length; x = x + 1){
                answer[x] = objects[objects.length-(x+1)];
            }
        return answer;
    }
}
